...
{
    public EditableGeometryCollectionAdapter(IntPtr pointer) : base(pointer) {}
}

public unsafe class EditableMesh : ObjectBase<UEditableMesh>
{
    public EditableMesh(IntPtr pointer) : base(pointer) {}
...
{
    public EditableMeshFactory(IntPtr pointer) : base(pointer) {}
...
{
    public EditableMeshAdapter(IntPtr pointer) : base(pointer) {}}

public unsafe class EditableStaticMeshAdapter : ObjectBase<UEditableStaticMeshAdapter>
{
    public EditableStaticMeshAdapter(IntPtr pointer) : base(pointer) {}
}
