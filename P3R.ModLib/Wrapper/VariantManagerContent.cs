...
public unsafe class VariantDependency : ObjectBase<FVariantDependency>
{
...
public unsafe class FunctionCaller : ObjectBase<FFunctionCaller>
{

}

public unsafe class CapturedPropSegment : ObjectBase<FCapturedPropSegment>
{
