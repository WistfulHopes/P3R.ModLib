...
{
    public MeshReconstructorBase(IntPtr pointer) : base(pointer) {}
...
{
    public MockDataMeshTrackerComponent(IntPtr pointer) : base(pointer) {}
...
{
    public MRMeshComponent(IntPtr pointer) : base(pointer) {}
