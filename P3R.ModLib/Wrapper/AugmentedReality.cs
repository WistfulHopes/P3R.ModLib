...
{
    public ARComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARPlaneComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARPointComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARBaseAsyncTaskBlueprintProxy(IntPtr pointer) : base(pointer) {}}

public unsafe class ARFaceComponent : ObjectBase<UARFaceComponent>
{
    public ARFaceComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARImageComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARQRCodeComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARPoseComponent(IntPtr pointer) : base(pointer) {}
...
{
    public AREnvironmentProbeComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARObjectComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARMeshComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARGeoAnchorComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARDependencyHandler(IntPtr pointer) : base(pointer) {}
...
{
    public ARGeoTrackingSupport(IntPtr pointer) : base(pointer) {}
...
{
    public CheckGeoTrackingAvailabilityAsyncTaskBlueprintProxy(IntPtr pointer) : base(pointer) {}
...
{
    public GetGeoLocationAsyncTaskBlueprintProxy(IntPtr pointer) : base(pointer) {}
...
{
    public ARLifeCycleComponent(IntPtr pointer) : base(pointer) {}
...
{
    public ARLightEstimate(IntPtr pointer) : base(pointer) {}}

public unsafe class ARBasicLightEstimate : ObjectBase<UARBasicLightEstimate>
{
    public ARBasicLightEstimate(IntPtr pointer) : base(pointer) {}
...
{
    public AROriginActor(IntPtr pointer) : base(pointer) {}}

public unsafe class ARPin : ObjectBase<UARPin>
{
    public ARPin(IntPtr pointer) : base(pointer) {}
...
{
    public ARSessionConfig(IntPtr pointer) : base(pointer) {}
...
{
    public ARSharedWorldGameMode(IntPtr pointer) : base(pointer) {}
...
{
    public ARSharedWorldGameState(IntPtr pointer) : base(pointer) {}
...
{
    public ARSharedWorldPlayerController(IntPtr pointer) : base(pointer) {}
...
{
    public ARSkyLight(IntPtr pointer) : base(pointer) {}
...
{
    public ARPlaneGeometry(IntPtr pointer) : base(pointer) {}
...
{
    public ARTrackedPoint(IntPtr pointer) : base(pointer) {}}

public unsafe class ARBlueprintLibrary : ObjectBase<UARBlueprintLibrary>
{
    public ARBlueprintLibrary(IntPtr pointer) : base(pointer) {}
...
{
    public ARTrackedQRCode(IntPtr pointer) : base(pointer) {}
}

public unsafe class ARFaceGeometry : ObjectBase<UARFaceGeometry>
{
    public ARFaceGeometry(IntPtr pointer) : base(pointer) {}
...
{
    public AREnvironmentCaptureProbe(IntPtr pointer) : base(pointer) {}
    public FVector GetExtent()
    {
        Span<(string name, object value)> @params = [
        ];
...
{
    public ARTrackedObject(IntPtr pointer) : base(pointer) {}
...
{
    public ARTraceResultLibrary(IntPtr pointer) : base(pointer) {}
...
{
    public ARTrackedPose(IntPtr pointer) : base(pointer) {}
...
{
    public ARMeshGeometry(IntPtr pointer) : base(pointer) {}
    public bool GetObjectClassificationAtLocation(ref FVector InWorldLocation, ref EARObjectClassification OutClassification, ref FVector OutClassificationLocation, float MaxLocationDiff)
    {
        Span<(string name, object value)> @params = [
            ("InWorldLocation", InWorldLocation), 
...
{
    public ARTrackedImage(IntPtr pointer) : base(pointer) {}
...
{
    public ARTrackableNotifyComponent(IntPtr pointer) : base(pointer) {}
}

public unsafe class ARTypesDummyClass : ObjectBase<UARTypesDummyClass>
{
    public ARTypesDummyClass(IntPtr pointer) : base(pointer) {}}

public unsafe class ARCandidateImage : ObjectBase<UARCandidateImage>
{
    public ARCandidateImage(IntPtr pointer) : base(pointer) {}
...
{
    public ARCandidateObject(IntPtr pointer) : base(pointer) {}
...
{
    public ARActor(IntPtr pointer) : base(pointer) {}
...
{
    public ARSaveWorldAsyncTaskBlueprintProxy(IntPtr pointer) : base(pointer) {}
...
{
    public ARGetCandidateObjectAsyncTaskBlueprintProxy(IntPtr pointer) : base(pointer) {}
...
{
    public ARGeoAnchor(IntPtr pointer) : base(pointer) {}
