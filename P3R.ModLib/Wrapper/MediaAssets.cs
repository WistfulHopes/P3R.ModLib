...
{
    public MediaSource(IntPtr pointer) : base(pointer) {}
...
{
    public BaseMediaSource(IntPtr pointer) : base(pointer) {}
}

public unsafe class FileMediaSource : ObjectBase<UFileMediaSource>
{
    public FileMediaSource(IntPtr pointer) : base(pointer) {}
...
{
    public MediaBlueprintFunctionLibrary(IntPtr pointer) : base(pointer) {}
...
{
    public MediaComponent(IntPtr pointer) : base(pointer) {}
...
{
    public MediaTimeStampInfo(IntPtr pointer) : base(pointer) {}
}

public unsafe class MediaPlayer : ObjectBase<UMediaPlayer>
{
    public MediaPlayer(IntPtr pointer) : base(pointer) {}
...
{
    public MediaPlaylist(IntPtr pointer) : base(pointer) {}
...
{
    public MediaSoundComponent(IntPtr pointer) : base(pointer) {}
...
{
    public MediaTexture(IntPtr pointer) : base(pointer) {}
    public void SetMediaPlayer(UMediaPlayer* NewMediaPlayer)
    {
        Span<(string name, object value)> @params = [
            ("NewMediaPlayer", (IntPtr)NewMediaPlayer)
...
{
    public PlatformMediaSource(IntPtr pointer) : base(pointer) {}
}

public unsafe class StreamMediaSource : ObjectBase<UStreamMediaSource>
{
    public StreamMediaSource(IntPtr pointer) : base(pointer) {}
}

public unsafe class TimeSynchronizableMediaSource : ObjectBase<UTimeSynchronizableMediaSource>
{
    public TimeSynchronizableMediaSource(IntPtr pointer) : base(pointer) {}
}
