...
public enum EQuartzCommandQuantization {
    Bar = 0,
    Beat = 1,
    ThirtySecondNote = 2,
    SixteenthNote = 3,
...
public enum EAtlSceneCaptureMode {
    ASCM_None = 0,
    ASCM_WriteSceneAlpha = 1,
    ASCM_MAX = 2,
};
...
public enum EMobileReflectionCompression {
    Default = 0,
    On = 1,
    Off = 2,
...
public enum EVertexOffsetUsageType {
    None = 0,
    PreSkinningOffset = 1,
...
public enum Default__UserDefinedEnum {
};
